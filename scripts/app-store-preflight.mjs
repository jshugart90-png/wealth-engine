 ...
 * Run: node scripts/app-store-preflight.mjs [--app games|tools|receipt-rush|webhook-whack|invoice-stack]
 */
...
const app = process.argv.includes("--app")
  ...
  : "games";
const MINI_GAMES = ["receipt-rush", "webhook-whack", "invoice-stack"];
