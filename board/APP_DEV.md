...
| **Bill Splitter Pro** | `com.wealthengine.billsplitterpro` | **TestFlight prep** | TBD | TBD | **READY** (Mac upload) |
...
See `mobile/TESTFLIGHT_ALL_APPS.md` for all 37 apps — bundle IDs, Fastlane lanes, versions.
